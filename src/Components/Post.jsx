	...
	return (
		<>
			<div className="bg-gray-900">
				<div className="flex flex-shrink-0 p-4 pb-0 bg-gray-900">
				...
				<div className="pl-16 pr-8">
					<p className="text-base  font-medium text-white">{postText}</p>
					{postImage && (
						<img src={postImage} alt="Post" className="mt-4 rounded-lg" />
					)}
